...
#[rustfmt::skip]
impl WatchRequest {
    pub fn new(topics: Topics, kinds: Vec<Kind>, agent_name: AgentName) -> Self {
        Self { topics, kinds, agent_name }
    }
    pub fn topics(&self) -> &Topics {
        &self.topics
    }
...
#[rustfmt::skip]
impl Rejection {
    pub fn new(rejection_reason: RejectionReason, description: Description) -> Self {
        Self {
            rejection_reason,
            description,
        }
