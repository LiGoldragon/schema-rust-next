...
pub mod family_identity {
    pub const ENTRY_FAMILY: [u8; 32] = [
        175, 55, 165, 94, 53, 120, 255, 131, 35, 117, 159, 139, 12, 122, 127, 30, 45, 76,
        102, 79, 127, 122, 188, 246, 5, 199, 51, 200, 153, 173, 149, 224,
    ];
    pub const OBSERVATION_FAMILY: [u8; 32] = [
        178, 211, 148, 238, 47, 71, 217, 236, 159, 93, 38, 21, 33, 184, 11, 215, 150,
        168, 197, 170, 33, 231, 72, 75, 226, 79, 96, 196, 109, 66, 95, 158,
    ];
}
