...
pub mod family_identity {
    pub const ENTRY_FAMILY: [u8; 32] = [
        229, 157, 22, 63, 94, 222, 27, 71, 122, 90, 131, 127, 199, 14, 102, 190, 135, 21,
        34, 232, 33, 123, 172, 115, 219, 41, 155, 81, 217, 195, 188, 12,
    ];
    pub const OBSERVATION_FAMILY: [u8; 32] = [
        249, 73, 168, 22, 176, 210, 29, 241, 182, 224, 216, 48, 2, 0, 15, 108, 143, 140,
        72, 101, 100, 253, 89, 151, 221, 152, 219, 19, 118, 204, 27, 71,
    ];
}
