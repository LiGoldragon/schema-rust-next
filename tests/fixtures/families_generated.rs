...
pub mod family_identity {
    pub const ENTRY_FAMILY: [u8; 32] = [
        56, 4, 81, 240, 240, 240, 202, 211, 93, 113, 50, 225, 60, 32, 177, 32, 171, 124,
        194, 186, 215, 198, 169, 229, 169, 178, 60, 223, 33, 25, 104, 157,
    ];
    pub const OBSERVATION_FAMILY: [u8; 32] = [
        82, 239, 49, 29, 16, 121, 214, 183, 51, 5, 10, 8, 131, 136, 243, 116, 12, 123,
        87, 133, 131, 135, 36, 164, 89, 117, 159, 255, 145, 158, 140, 158,
    ];
}
