...
pub mod family_identity {
    pub const ENTRY_FAMILY: [u8; 32] = [
        198, 116, 186, 177, 215, 244, 155, 144, 75, 209, 142, 139, 153, 15, 94, 12, 195,
        16, 241, 157, 102, 170, 148, 1, 18, 13, 39, 65, 183, 189, 162, 248,
    ];
    pub const OBSERVATION_FAMILY: [u8; 32] = [
        90, 78, 171, 59, 202, 104, 181, 30, 142, 47, 35, 121, 100, 159, 96, 122, 248,
        111, 134, 31, 6, 199, 46, 27, 43, 207, 56, 124, 219, 227, 145, 77,
    ];
}
