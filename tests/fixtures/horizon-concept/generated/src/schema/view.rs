...
#[derive(rkyv::Archive, rkyv::Serialize, rkyv::Deserialize, Clone, Debug, PartialEq, Eq)]
pub struct DomainName(pub Text);

#[derive(rkyv::Archive, rkyv::Serialize, rkyv::Deserialize, Clone, Debug, PartialEq, Eq)]
pub struct SshTarget(pub Text);
...
#[derive(rkyv::Archive, rkyv::Serialize, rkyv::Deserialize, Clone, Debug, PartialEq, Eq)]
pub struct WorkstationView(pub HostView);

#[derive(rkyv::Archive, rkyv::Serialize, rkyv::Deserialize, Clone, Debug, PartialEq, Eq)]
pub struct RouterView(pub HostView);

#[derive(rkyv::Archive, rkyv::Serialize, rkyv::Deserialize, Clone, Debug, PartialEq, Eq)]
pub struct Horizon {
    pub cluster_name: ClusterName,
    pub workstation_view: WorkstationView,
    pub router_view: RouterView,
}

#[derive(rkyv::Archive, rkyv::Serialize, rkyv::Deserialize, Clone, Debug, PartialEq, Eq)]
pub struct ViewReceipt(pub Integer);
...
impl HostView {
    pub fn from_nota_block(block: &nota_next::Block) -> Result<Self, NotaDecodeError> {
        let children = NotaBlock::new(block).expect_children(nota_next::Delimiter::Parenthesis, "parenthesis", "HostView", 3)?;
        Ok(Self {
            node_name: NodeName::from_nota_block(&children[0])?,
            domain_name: DomainName::from_nota_block(&children[1])?,
            ssh_target: SshTarget::from_nota_block(&children[2])?,
        })
    }
    ...
    pub fn to_nota(&self) -> String {
        let fields = [
            ...
            self.domain_name.to_nota(),
            self.ssh_target.to_nota(),
        ];
        format!("({})", fields.join(" "))
    }
}
...
impl WorkstationView {
    pub fn from_nota_block(block: &nota_next::Block) -> Result<Self, NotaDecodeError> {
        Ok(Self(HostView::from_nota_block(block)?))
    }
...
impl Horizon {
    pub fn from_nota_block(block: &nota_next::Block) -> Result<Self, NotaDecodeError> {
        let children = NotaBlock::new(block).expect_children(nota_next::Delimiter::Parenthesis, "parenthesis", "Horizon", 3)?;
        Ok(Self {
            cluster_name: ClusterName::from_nota_block(&children[0])?,
            workstation_view: WorkstationView::from_nota_block(&children[1])?,
            router_view: RouterView::from_nota_block(&children[2])?,
        })
    }
    ...
    pub fn to_nota(&self) -> String {
        let fields = [
            ...
            self.workstation_view.to_nota(),
            self.router_view.to_nota(),
        ];
        format!("({})", fields.join(" "))
    }
}
...
impl Input {
    pub fn from_nota_block(block: &nota_next::Block) -> Result<Self, NotaDecodeError> {
        ...
        match variant {
            "Render" => Ok(Self::Render(Horizon::from_nota_block(&children[1])?)),
    ...
    pub fn to_nota(&self) -> String {
        match self {
            Self::Render(payload) => format!("(Render {})", payload.to_nota()),
        }
    }
}
...
impl Output {
    pub fn from_nota_block(block: &nota_next::Block) -> Result<Self, NotaDecodeError> {
        ...
        let variant = children[0].demote_to_string().ok_or(NotaDecodeError::ExpectedAtom { type_name: "enum variant" })?;
        match variant {
            "Rendered" => Ok(Self::Rendered(ViewReceipt::from_nota_block(&children[1])?)),
    ...
    pub fn to_nota(&self) -> String {
        match self {
            Self::Rendered(payload) => format!("(Rendered {})", payload.to_nota()),
        }
    }
}
...
pub mod short_header {
    pub const INPUT_RENDER: u64 = 0x0000000000000000;
    pub const OUTPUT_RENDERED: u64 = 0x0100000000000000;
}
...
impl Input {
    pub fn route(&self) -> InputRoute {
        match self {
            Self::Render(_) => InputRoute::Render,
        }
    }

    pub fn short_header(&self) -> u64 {
        match self {
            Self::Render(_) => short_header::INPUT_RENDER,
        }
    }

    pub fn route_from_short_header(header: u64) -> Result<InputRoute, SignalFrameError> {
        match header {
            short_header::INPUT_RENDER => Ok(InputRoute::Render),
...
impl Output {
    pub fn route(&self) -> OutputRoute {
        match self {
            Self::Rendered(_) => OutputRoute::Rendered,
        }
    }

    pub fn short_header(&self) -> u64 {
        match self {
            Self::Rendered(_) => short_header::OUTPUT_RENDERED,
        }
    }

    pub fn route_from_short_header(header: u64) -> Result<OutputRoute, SignalFrameError> {
        match header {
            short_header::OUTPUT_RENDERED => Ok(OutputRoute::Rendered),
...
pub trait InputNexus {
    ...
    fn render(&self, mail: NexusMail<Horizon>) -> Result<Self::Reply, Self::Error>;
}
...
impl Input {
        ...
        NexusActor: InputNexus,
    {
        let reply = match self {
            Self::Render(payload) => nexus.render(NexusMail::new(identifier, origin_route, payload)),
        }?;
...
pub trait OutputNexus {
    ...
    fn rendered(&self, mail: NexusMail<ViewReceipt>) -> Result<Self::Reply, Self::Error>;
}
...
impl Output {
    ...
    {
        let reply = match self {
            Self::Rendered(payload) => nexus.rendered(NexusMail::new(identifier, origin_route, payload)),
        }?;
        Ok(MessageProcessed::new(identifier, origin_route, reply))
    }
}
